...
- **Визитка (Business Card)** — лаконичный дизайн с фирменным логотипом и контактами.
- **Иконка мобильного приложения** — узнаваемый пин на ярком интуитивном градиенте для App Store / Google Play.
- **Веб-баннер / Обложка** — слоган «Город без барьеров» и призыв «Присоединиться к сообществу волонтёров →».

### Логотип

Концентрические круги — символ радара, поиска и доступности. Ассоциируется с навигацией и заботой о каждом пользователе.
...
данных              1–3 млн ₽/год              300–700 ты�� ₽/объект
...
- [ ] **Пилот ЦАО Москвы** — тестирование с реальными пользо��ателями
